...
class Toolbar(ttk.Frame):
    ...
    def __init__(self, parent, actions: Optional[List[ActionSpec]] = None, style: str = "Panel.TFrame", **kwargs):
    ...
    def add_button(self, label: str, btn_style: str, command: Callable, side: str = "left") -> ttk.Button:
