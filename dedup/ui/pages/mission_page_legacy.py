...
class MissionPageLegacy(ttk.Frame):
    """Mission / home page — CEREBRO launch hub (pre-MVVM wiring hook)."""
    ...
    def __init__(
        ...
        *,
        vm: Optional[MissionVM] = None,
        after_store_refresh: Optional[Callable[[], None]] = None,
        **kwargs,
    ):
        ...
        self._after_store_refresh = after_store_refresh
        self.vm = vm or MissionVM()
    ...
    def attach_store(self, store: "UIStateStore") -> None:
        ...
        def on_state(state):
            ...
            if self._after_store_refresh:
                self._after_store_refresh()
